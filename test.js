...
describe('standard-version', function () {
  ...
  describe('configuration', () => {
    it.skip('reads config from package.json', async function () {
      const issueUrlFormat =
        'https://standard-version.company.net/browse/{{id}}'
      mock({
        bump: 'minor',
    ...
    it.skip('reads config from .versionrc', async function () {
    ...
    it.skip('reads config from .versionrc.json', async function () {
      const issueUrlFormat = 'http://www.foo.com/{{id}}'
      const changelog = ({ preset }) => preset.issueUrlFormat
      mock({ bump: 'minor', changelog })
      fs.writeFileSync(
    ...
    it.skip('evaluates a config-function from .versionrc.js', async function () {
      const issueUrlFormat = 'http://www.foo.com/{{id}}'
    ...
    it.skip('evaluates a config-object from .versionrc.js', async function () {
      const issueUrlFormat = 'http://www.foo.com/{{id}}'
    ...
    it.skip('throws an error when a non-object is returned from .versionrc.js', async function () {
      mock({ bump: 'minor' })
