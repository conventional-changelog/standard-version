...
const configPath = findUp.sync(['.versionrc.js', '.versionrc', '.versionrc.json'])
const configExt = path.extname(configPath)
const config = configPath ? configExt === '.js' ? require(configPath) : JSON.parse(readFileSync(configPath)) : {}
